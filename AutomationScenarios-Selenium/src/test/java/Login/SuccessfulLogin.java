...
public class SuccessfulLogin {
	...
	public static void main(String[] args) {
		...
		((JavascriptExecutor) driver)
				.executeScript("arguments[0].scrollIntoView({behavior: 'instant', block: 'center'});", userName);
		...
		((JavascriptExecutor) driver)
				.executeScript("arguments[0].scrollIntoView({behavior: 'instant', block: 'center'});", loginButton);
		loginButton.click();
		...
		String actualText = driver
				.findElement(By.xpath("//h1[text()='Secure Area page for Automation Testing Practice']")).getText();
		...
		((JavascriptExecutor) driver)
				.executeScript("arguments[0].scrollIntoView({behavior: 'instant', block: 'center'});", logoutButton);
		logoutButton.click();
